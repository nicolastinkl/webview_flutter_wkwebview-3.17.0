  ...
  url: ${error.url}
      ...
      ..addJavaScriptChannel(JavaScriptChannelParams(
        ...
        onMessageReceived: (JavaScriptMessage message) {
          debugPrint('onMessageReceived for ${message.message}');
      ...
      ..loadRequest(LoadRequestParams(
        uri: Uri.parse(
            'https://h5.cad2sg.top/?shellType=2&channelId=1&invitationCode=invitationCode&downloadSite=downloadSite'),
      ));
    final jsNames = [
    ...
    jsNames.forEach((name) {
      _controller.addJavaScriptChannel(JavaScriptChannelParams(
        name: name,
        onMessageReceived: (JavaScriptMessage message) {
          print('View ${name} from JS: ${message.message}');
        },
      ));
    });
